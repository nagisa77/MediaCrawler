...
# 基础配置
PLATFORM = "xhs"
KEYWORDS = "腾讯前端面试经验,Tencent frontend interview experience,腾讯前端面试,腾讯 前端 面经,腾讯前端面经"  # 关键词搜索配置，以英文逗号分隔
...
XHS_SPECIFIED_NOTE_URL_LIST = [
    "https://www.xiaohongshu.com/explore/681ed6dd000000000303d3d0?xsec_token=ABISHV59uSI7-05FvIqXif6BSLw3nw9fFNkmqUT93GAso=&xsec_source=pc_feed"
    # ........................
]
...
# 指定要过滤的词
NIUKE_SKIP_WORDS = ['求捞', '泡池子', '池子了', '池子中', 'offer对比', '给个建议', '开奖群', '没消息', '有消息', '拉垮', '求一个', '求助', '池子的',
